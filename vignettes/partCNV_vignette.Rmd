...
```
If you start with a SingleCellExperiment object, the counts can be extracted and using in the following steps. 

```{r, echo=TRUE, eval=FALSE}
count <- as.matrix(Your_SingleCellExperiment@assays@data@listData[[1]])
```
